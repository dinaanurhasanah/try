            ...
            n.length > 0) {
                if (i.find(".yikes-mailchimp-required-interest-group-error").length > 0)
                    i.find(".yikes-mailchimp-required-interest-group-error").fadeOut("fast", function() {
                        for (var e in i.find(".yikes-mailchimp-required-interest-group-error").remove(),
                        n)
                ...
                return i.find(".yikes-easy-mc-submit-button").removeAttr("disabled", "disabled"),
                i.find("input, label, button").not(":hidden").fadeTo("fast", 1),
                i.find(".yikes-mailchimp-preloader").remove(),
                s(".yikes-mc-loading-dots").remove(),
                s(".yikes-mailchimp-submit-button-span-text").show(),
                i.removeClass("yikes-mc-submitted-form-loading"),
                !1
            }
            ...
            return void 0 !== e.yikesGoogleRecaptchaV3 ? yikesRecaptchaV3(function() {
                return s.ajax({
                    ...
                    success: function(e, n, o) {
                        if (i.find("input, label, button").not(":hidden").fadeTo("fast", 1),
                        i.find(".yikes-mailchimp-preloader").remove(),
                        s(".yikes-mc-loading-dots").remove(),
                        s(".yikes-mailchimp-submit-button-span-text").show(),
                        i.removeClass("yikes-mc-submitted-form-loading"),
                        i.trigger("yikes_mailchimp_ajax_submission", e),
                        e.success) {
                            e = e.data,
                            "function" == typeof yikes_mailchimp_google_analytics_success && yikes_mailchimp_google_analytics_success(e),
                            1 == e.hide && (s(".yikes-easy-mc-form-description-" + r).length > 0 && s(".yikes-easy-mc-form-description-" + r).hide(),
                            i.hide());
                            ...
                            "before" === a.l10n.feedback_message_placement ? m.before(c) : "after" === a.l10n.feedback_message_placement ? i.after(c) : "both" === a.l10n.feedback_message_placement && (m.before(c),
                            i.after(c)),
                            ...
                            if ("before" === a.l10n.feedback_message_placement ? u.before(f) : "after" === a.l10n.feedback_message_placement ? i.after(f) : "both" === a.l10n.feedback_message_placement && (u.before(f),
                            i.after(f)),
                            void 0 !== e && void 0 !== e.missing_required_field && !0 === e.missing_required_field)
